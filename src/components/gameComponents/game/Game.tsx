...
type AppActions = ToggleGameStartedAction | ToggleGameDifficultyAction | ToggleGameWonAction | ToggleGameLostAction | IncrementScoreAction | ResetGameAction;
...
function Game() {
  const [state, dispatch] = useReducer(gameReducer, {gameStarted: false, gameWon: false, gameLost: false, gameDifficulty: "easy", cardTotal: 4, score: 0});
